...
class GOST28147Engine {
  ...
  int _GOST28147_mainStep(int n1, int key) {
    ...
    // S-box replacing
    int om;
    om = _S[0 + ((cm >> (0 * 4)) & 0xF)] << (0 * 4);
    om += _S[16 + ((cm >> (1 * 4)) & 0xF)] << (1 * 4);
    om += _S[32 + ((cm >> (2 * 4)) & 0xF)] << (2 * 4);
    om += _S[48 + ((cm >> (3 * 4)) & 0xF)] << (3 * 4);
    om += _S[64 + ((cm >> (4 * 4)) & 0xF)] << (4 * 4);
    om += _S[80 + ((cm >> (5 * 4)) & 0xF)] << (5 * 4);
    om += _S[96 + ((cm >> (6 * 4)) & 0xF)] << (6 * 4);
    om += _S[112 + ((cm >> (7 * 4)) & 0xF)] << (7 * 4);
  ...
  void _GOST28147Func(
    ...
    if (_forEncryption) {
      for (int k = 0; k < 3; k++) {
        ...
        for (int j = 0; j < 8; j++) {
          tmp = N1;
          N1 = N2 ^ _GOST28147_mainStep(N1, workingKey[j]); // CM2
          N2 = tmp;
        }
      }
      for (int j = 7; j > 0; j--) {
    ...
    N2 = N2 ^ _GOST28147_mainStep(N1, workingKey[0]); // 32 step (N1=N1)
